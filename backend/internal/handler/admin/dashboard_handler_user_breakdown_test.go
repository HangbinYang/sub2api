...
func TestGetUserBreakdown_ResponseFormat(t *testing.T) {
	repo := &userBreakdownRepoCapture{
		result: []usagestats.UserBreakdownItem{
			{UserID: 1, Email: "alice@test.com", Notes: "重点客户", Balance: 23.45, Requests: 100, TotalTokens: 50000, Cost: 1.5, ActualCost: 1.2},
	...
	require.Equal(t, "重点客户", resp.Data.Users[0].Notes)
	require.InDelta(t, 23.45, resp.Data.Users[0].Balance, 0.001)
